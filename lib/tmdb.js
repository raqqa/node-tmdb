...
tmdb.prototype.movie = {
	//info: function (q, lang, callback) {
	info: function () {
		/*if (lang != null)
			var url = me.api_urls.movie_info.format(q) + "&language=" + lang;
		else
			var url = me.api_urls.movie_info.format(q);*/
		if (arguments.length == 3) {
			var url = me.api_urls.movie_info.format(arguments[0]) + "&language=" + arguments[1];
			executeQuery({
				url: url
			}, arguments[2]);
		} else {
	...
	, images: function () {
		if (arguments.length == 2) {
			...
			var url = me.api_urls.movie_images.format(arguments[0]) + "&language=" + arguments[1];
			executeQuery({
				url: url
			}, arguments[2]);
		}
	...
	, trailers: function (q, callback) {
		if (arguments.length == 2) {
			...
			var url = me.api_urls.movie_trailers.format(arguments[0]) + "&language=" + arguments[1];
			executeQuery({
				url: url
			}, arguments[2]);
		}
