...
var tmdb = function(api_key) {
	...
	this.get_api_urls = function() {
		return {
			configuration:              this.base+'/configuration?api_key='+me.api_key+(me.language?'&language='+me.language:''),
			misc_latest:                this.base+'/movie/latest?api_key='+me.api_key+(me.language?'&language='+me.language:''),
            misc_upcoming:              this.base+'/movie/upcoming?page={0}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
			misc_now_playing:           this.base+'/movie/now-playing?page={0}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
			misc_popular:               this.base+'/movie/popular?page={0}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
			misc_top_rated:             this.base+'/movie/top-rated?page={0}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
			movie_info:                 this.base+'/movie/{0}?api_key='+me.api_key+(me.language?'&language='+me.language:'')+(me.language?'&language='+me.language:''),
			movie_alternative_titles:   this.base+'/movie/{0}/alternative_titles?api_key='+me.api_key+(me.language?'&language='+me.language:''),
			movie_casts:                this.base+'/movie/{0}/casts?api_key='+me.api_key+(me.language?'&language='+me.language:''),
			movie_images:               this.base+'/movie/{0}/images?api_key='+me.api_key+(me.language?'&language='+me.language:''),
			movie_keywords:             this.base+'/movie/{0}/keywords?api_key='+me.api_key+(me.language?'&language='+me.language:''),
			movie_releases:             this.base+'/movie/{0}/releases?api_key='+me.api_key+(me.language?'&language='+me.language:''),
			movie_trailers:             this.base+'/movie/{0}/trailers?api_key='+me.api_key+(me.language?'&language='+me.language:''),
			movie_translations:         this.base+'/movie/{0}/translations?api_key='+me.api_key+(me.language?'&language='+me.language:''),
            movie_similar:              this.base+'/movie/{0}/similar_movies?page={1}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
			person_info:                this.base+'/person/{0}?api_key='+me.api_key+(me.language?'&language='+me.language:''),
			person_credits:             this.base+'/person/{0}/credits?api_key='+me.api_key+(me.language?'&language='+me.language:''),
			person_images:              this.base+'/person/{0}/images?api_key='+me.api_key+(me.language?'&language='+me.language:''),
			collection_info:            this.base+'/collection/{0}?api_key='+me.api_key+(me.language?'&language='+me.language:''),
			search_movie:               this.base+'/search/movie?query={0}&page={1}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
			search_person:              this.base+'/search/person?query={0}&page={1}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
            search_companies:           this.base+'/search/company?query={0}&page={1}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
			auth_request_token:			this.base+'/authentication/token/new?api_key='+me.api_key+(me.language?'&language='+me.language:''),
			auth_session_id:			this.base+'/authentication/session/new?request_token={0}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
			write_rate_movie:			this.base+'/movie/{0}/rating?session_id={1}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
            company_info:               this.base+'/company/{0}?api_key='+me.api_key+(me.language?'&language='+me.language:''),
            company_movies:             this.base+'/company/{0}/movies?api_key='+me.api_key+(me.language?'&language='+me.language:''),
            account_info:               this.base+'/account?session_id={0}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
            account_add_favorite:       this.base+'/account/{0}/favorite?session_id={1}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
            account_favorite_movies:    this.base+'/account/{0}/favorite_movies?session_id={1}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
            account_add_movie_watchlist: this.base+'/account/{0}/movie_watchlist?session_id={1}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
            account_movie_watchlist:    this.base+'/account/{0}/movie_watchlist?session_id={1}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
            account_rated_movies:       this.base+'/account/{0}/rated_movies?session_id={1}&api_key='+me.api_key+(me.language?'&language='+me.language:''),
            genre_list:                 this.base+'/genre/list?api_key='+me.api_key+(me.language?'&language='+me.language:''),
            genre_movies:               this.base+'/genre/{0}/movies?page={0}&page={1}&api_key='+me.api_key+(me.language?'&language='+me.language:'')
		};
	};
	this.api_urls = this.get_api_urls();
	
	this.setLanguage = function(language) {
		me.language = language;
		me.api_urls = me.get_api_urls();
	};
